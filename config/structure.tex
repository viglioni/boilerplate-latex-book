...
\definecolor[named]{color01}{rgb}{.85,.07,.23} % Color used in the title page
\usepackage{wallpaper} % Required for setting background images (title page)

\usepackage[unicode=true,bookmarks=true,bookmarksnumbered=false,bookmarksopen=false,breaklinks=false,pdfborder={0 0 0},backref=section,colorlinks=false]{hyperref} % PDF meta-information specification
...
\renewcommand{\foottextfont}{\itshape\fontsize{6}{7}\selectfont}%{\itshape\footnotesize} % Font settings for footnotes
